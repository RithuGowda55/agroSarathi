...
const ProductionCostCalculator = () => {
  ...
  const calculateOutputs = () => {
    ...
    const newOutputs = {
      ...
      supervisoryCharges:
        0.1 * ((i.familyMaleDays || 0) * (i.familyMaleRate || 0)) +
        (i.familyFemaleDays || 0) * (i.familyFemaleRate || 0),
      totalCost:
        // Cost A
        (i.maleDays || 0) * (i.maleRate || 0) +
      ...
      BCRATIO:
        ...
        (i.maleDays || 0) * (i.maleRate || 0) +
          ...
          0.1 *
            ((i.familyMaleDays || 0) * (i.familyMaleRate || 0) +
              (i.familyFemaleDays || 0) * (i.familyFemaleRate || 0)) || 1), // Avoid division by zero by defaulting denominator to 1
          ...
          <div style={{ flex: 1 }}>
            <h2
              style={{
                ...
                fontSize: "24px",
                fontWeight: "bold",
                background: "linear-gradient(to right,rgb(52 146 166), rgb(23 184 150))", // Gradient color
                color: "white",
                padding: "10px 20px",
                borderRadius: "10px",
            ...
            <form>
              <Card
                style={{
                  maxWidth: "450px",
                  margin: "22px",
                  backgroundColor: "rgb(205 222 224)",
                  borderRadius: "30px",
                }}
              >
                <Card.Body style={{ margin: "22px" }}>
                  <div
                    style={{
                      fontSize: "20px",
                      margin: "px",
          ...
          <div style={{ flex: 1 }} className="output-section">
            ...
            <div className="output-container">
              <div className="output-card">
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <div style={cardStyle}>Labour Costs Output</div>

                    <p className="output-label">
                      <strong>
                        Labor Cost (Male): {outputs.hiredMaleLabour || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                      <strong>
                        Labor Cost (Female): {outputs.hiredFemaleLabour || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                      <strong>
                        Labor Cost (Bullock): {outputs.bullockLabour || 0}
                      </strong>
                    </p>
                  </Card.Body>
                </Card>
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <div style={cardStyle}>Machinery and Material Costs</div>
                    <p className="output-label">
                      <strong>
                        Machinery Charges: {outputs.machineryCharges || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <div style={cardStyle}>Other Operational Costs</div>
                    <p className="output-label">
                      <strong>
                        Fertilizer Cost: {outputs.fertilizerCost || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                      <strong>
                        Irrigation Charges: {outputs.irrigationCharges || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                      <strong>
                        Insecticide Cost: {outputs.insecticidesCost || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                    ...
                    <p className="output-label">
                      <strong>
                        Miscellaneous Charges: {outputs.miscCharges || 0}
                      </strong>
                    </p>
                  </Card.Body>
                </Card>
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <div style={cardStyle}>Interest on Working Capital</div>
                    <p className="output-label">
                      <strong>
                        Interest on Working Capital:{" "}
                        {outputs.interestWorkingCapital || 0}
                      </strong>
                    </p>
                  </Card.Body>
                </Card>
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <div style={cardStyle}>
                      Cost A=Labour Costs Output+Machinery and Material
                      Costs+Other Operational Costs+Interest on Working Capital
                    </div>
                    <p className="output-label">
                ...
                >
                  <Card.Body style={{ margin: "22px" }}>
                    <p className="output-label">
                      <div style={cardStyle}>Pricing Information for Yield</div>
                      <strong>
                        Value of Main Product: {outputs.valueMainProduct || 0}
                      </strong>
                    </p>
                    <p className="output-label">
                      <strong>
                        Value of By-Product: {outputs.valueByProduct || 0}
                      </strong>
                    </p>
                  </Card.Body>
                </Card>
                ...
                <Card
                  ...
                  >
                  <Card.Body style={{ margin: "22px" }}>
                  <div style={cardStyle}>Sum of Values of Main and By-Product</div>
                <p className="output-label">
                ...
                <Card
                  ...
                  >
                  <Card.Body style={{ margin: "22px" }}>
                  <div style={cardStyle}>Rental and Interest</div>
                <p className="output-label">
                  <strong>
                    Rental Value of Land: {outputs.rentalvalueofland || 0}
                  </strong>
                </p>
                <p className="output-label">
                  <strong>
                    Interest on Fixed Capital:{" "}
                    {outputs.InterestonFixedCapital || 0}
                  </strong>
                </p>
                    </Card.Body>
                  </Card>
                ...
                <Card
                  ...
                  >
                  <Card.Body style={{ margin: "22px" }}>
                  <div style={cardStyle}>Cost A + Rental Value of Land + Interest on Fixed Capital</div>
                <p className="output-label">
                ...
                <Card
                  ...
                  >
                  <Card.Body style={{ margin: "22px" }}>
                  <div style={cardStyle}>Family Labour</div>
                <p className="output-label">
                  <strong>
                    Family Human Labor (Male):{" "}
                    {outputs.familyHumanLaborMale || 0}
                  </strong>
                </p>
                <p className="output-label">
                  <strong>
                    Family Human Labor (Female):{" "}
                    {outputs.familyHumanLaborFemale || 0}
                  </strong>
                </p>
                    </Card.Body>
                  </Card>
                <Card
                  ...
                  >
                  <Card.Body style={{ margin: "22px" }}>
                  <div style={cardStyle}>Total Cost of Production Calculation</div>
                <p className="output-label">
                  <strong>
                    Supervisory Charges: {outputs.supervisoryCharges || 0}
                  </strong>
                </p>
                <p className="output-label">
                ...
                <p className="output-label">
                  <strong>
                    Benefit-Cost Ratio (BCR): {outputs.BCRATIO || 0}
                  </strong>
                </p>
                <p className="output-label">
                ...
                <p className="output-label">
                  <strong>
                    Cost per Quintal: {outputs.costPerQuintal || 0}
                  </strong>
                </p>
                <p className="output-label">
